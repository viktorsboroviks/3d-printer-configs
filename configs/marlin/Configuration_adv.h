...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  30, (Y_BED_SIZE/2) }, { (X_BED_SIZE-30),  (Y_BED_SIZE/2) } }
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      400 // pancake motor is used
    #define E0_MICROSTEPS    16
  ...
  #define STEALTHCHOP_E //required for linear advance
   ...
   */
  #define SQUARE_WAVE_STEPPING //required for linear advance
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Unload 650mm"
  ...
  #define USER_DESC_3 "Heat bed&E: PETG"
